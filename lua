...
function Fun.Create(title)
    ...
    Shadow.ImageColor3 = Color3.fromRGB(25, 25, 35)
Shadow.ImageTransparency = 0.7
    ...
    function tabHandling:Tab(tabText)
        ...
        local function createTabButton(tabText)
            ...
            tabButton.Size = UDim2.new(0, 149, 0, 40)
...
tabButton.MouseButton1Click:Connect(function()
    ...
    local tween = tweenService:Create(tabButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(35, 35, 45)})
    tween:Play()
