...
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/NevaHub0/SaveManager/main/.lua"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/NevaHub0/InterfaceManager/main/.lua"))()
--------------------------------------------------------------------------------------------------------------------------------------------
...
local Tabs = {
    ...
    Race = Window:AddTab({ Title = "RaceV4 & Mirage", Icon = "chevrons-right" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "shopping-cart" }),
	Misc = Window:AddTab({ Title = "Misc(Fun)", Icon = "list-plus" }),
}
...
ImageButton.Image = "rbxassetid://12258186601"
...
--Setting
    ...
    local FastAttackDisabled = function(a, b, c, d, func)
    ...
    spawn(function()
        while task.wait() do
            pcall(function()
                ...
                STOPRL.wrapAttackAnimationAsync = FastAttackDisabled
            end)
        end
    end)
    ...
    function AttackHit()
        local CombatFrameworkLib = debug.getupvalues(require(game.Players.LocalPlayer.PlayerScripts.CombatFramework))
        local CmrFwLib = CombatFrameworkLib[2]
...
--------------------------------------------------------------------------------------------------------------------------------------------
--misc
local ToggleRainbowHaki = Tabs.Misc:AddToggle("ToggleRainbowHaki", {Title = "Rainbow Haki ", Default = value })
...
local ToggleRainbowYoru = Tabs.Misc:AddToggle("ToggleRainbowYoru", {Title = "Rainbow Yoru ", Default = value })
...
local ToggleInfiniteObRange = Tabs.Misc:AddToggle("ToggleInfiniteObRange", {Title = "Infinite Obversation Range", Default = value })
...
local ToggleShowChatdisabled = Tabs.Misc:AddToggle("ToggleShowChatdisabled", {Title = "Show Chat disabled", Default = value })
...
StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true)    
    ...
    local ToggleShowleaderboarddisabled = Tabs.Misc:AddToggle("ToggleShowleaderboarddisabled", {Title = "Show leaderboard disabled", Default = a })
...
game:GetService('StarterGui'):SetCoreGuiEnabled(Enum.CoreGuiType.PlayerList, true)   
  ...
  local ToggleHighlightMode = Tabs.Misc:AddToggle("ToggleHighlightMode", {Title = "Highlight Mode", Default = value })
        ...
        local ToggleXray = Tabs.Misc:AddToggle("ToggleXray", {Title = "Xray ", Default = value })
...
Tabs.Misc:AddButton({
    ...
    local ToggleGraphic = Tabs.Misc:AddToggle("ToggleGraphic", {Title = "Graphic ", Default = v })
